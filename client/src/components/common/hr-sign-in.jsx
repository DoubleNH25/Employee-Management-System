...
export const HRSignIn = ({ image, handlesigninform, handlesigninsubmit, targetedstate, statevalue, redirectpath }) => {
    return (
        <>
            ...
            <div className="flex min-h-full flex-1 min-[200px]:flex-col md:flex-row md:items-center justify-center px-6 py-12 lg:px-8 md:gap-5">
                ...
                <div className="my-5 sm:mx-auto sm:w-full sm:max-w-sm lg:mx-10">
                    ...
                    <p className="mt-6 text-center text-sm text-gray-500">
                        ...
                        <Link to="/auth/HR/signup" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                            Sign up here
                        </Link>
                    </p>
                </div>
