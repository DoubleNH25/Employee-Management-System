...
export const HandleGetMyProfile = createAsyncThunk("HandleGetMyProfile", async (_, { rejectWithValue }) => {
    try {
        const response = await apiService.get(HREndPoints.MY_PROFILE, {
            withCredentials: true
        })
        return response.data
    } catch (error) {
...
export const HandleUpdateMyProfile = createAsyncThunk("HandleUpdateMyProfile", async (profileData, { rejectWithValue }) => {
    try {
        const response = await apiService.patch(HREndPoints.MY_PROFILE, profileData, {
            withCredentials: true
        })
        return response.data
    } catch (error) {
